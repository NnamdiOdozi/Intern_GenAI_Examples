...
meta = [
    ...
    ("Model (all rounds)", "Qwen3.5-35B-A3B-FP8-dottxt"),
...
mrows = [
    ...
    ("R1 model / schema", "Qwen3.5-35B-A3B-FP8-dottxt / round1-discovery"),
    ("R2 model / schema", "Qwen3.5-35B-A3B-FP8-dottxt / round2-extraction"),
    ("R3 model / schema", "Qwen3.5-35B-A3B-FP8-dottxt / round3-table-validation + round3-document-audit"),
