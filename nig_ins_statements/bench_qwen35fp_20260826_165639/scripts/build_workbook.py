...
meta = [
    ...
    ("Model (all rounds)", "Qwen/Qwen3.5-35B-A3B-FP8-dottxt [reasoning=none, frequency_penalty=0.5]"),
...
mrows = [
    ...
    ("R1 model / schema", "Qwen3-VL-30B / round1-discovery"),
    ("R2 model / schema", "Qwen3-VL-235B / round2-extraction"),
    ("R3 model / schema", "Qwen3-VL-235B / round3-table-validation + round3-document-audit"),
